...
preview_device_url: "/docs/v2/demos/src/input/basic"
...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic/edit/master//Users/Alex/Desktop/git/ionic/src/components/input/input.ts#L15">
Improve this doc
</a>
...
<code>password</code>, <code>email</code>, <code>number</code>, <code>search</code>, <code>tel</code>, and <code>url</code>, and is 
commonly used with the <a href="../../label/Label">Label component</a> inside of <code>ion-item</code>. 
Ionic uses an actual <code>&lt;input type=&quot;text&quot;&gt;</code> HTML element within the
component, however, with Ionic wrapping the native HTML input
element it&#39;s able to better handle the user experience and
interactivity. Similarly, <a href="../TextArea"><code>&lt;ion-textarea&gt;</code></a> should be 
used in place of <code>&lt;textarea&gt;</code>.</p>
<p>Inputs are often used with the 
<a href="https://angular.io/docs/ts/latest/guide/forms.html">Angular 2 Form module</a> 
to enable features like input validation and form submission.</p>
...
<h3 id="inset-inputs">Inset Inputs</h3>
<p>By default each input item will fill 100% of the width of its parent element. Make 
the input inset by including it in a list, then adding the <code>inset</code> attribute to the 
<code>ion-list</code> component.</p>
