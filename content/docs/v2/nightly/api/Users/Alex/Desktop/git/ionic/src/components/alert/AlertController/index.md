...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic/edit/master//Users/Alex/Desktop/git/ionic/src/components/alert/alert.ts#L366">
Improve this doc
</a>
...
<p>AlertController is used to create instances of the Alert class for displaying 
the Alert component.</p>
<p>For complete information on creating and using the Alert component, see the 
<a href="../Alert">Alert API docs</a></p>
...
<table class="table param-table" style="margin:0;">
  ...
  <code>Object</code>
      ...
      <td>
        <p>Options object that sets the appearance and behavior of the Alert. 
                     See <a href="../Alert#alert-options">Alert options</a> in the 
                     Alert API doc.</p>
...
<a href='../Alert'>Alert API Docs</a><!-- end content block -->
