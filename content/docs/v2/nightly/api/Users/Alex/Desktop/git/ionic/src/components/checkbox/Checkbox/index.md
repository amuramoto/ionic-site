...
preview_device_url: "/docs/v2/demos/src/checkbox/basic"
...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic/edit/master//Users/Alex/Desktop/git/ionic/src/components/checkbox/checkbox.ts#L13">
Improve this doc
</a>
...
<p>The Checkbox is a simple component that is styled based on the mode (iOS, Android, Windows Univeral). 
It can be placed in an <code>ion-item</code> or used as a stand-alone checkbox.</p>
<p>For more info on forms and inputs, see the 
<a href="https://angular.io/docs/ts/latest/guide/forms.html">Angular 2 Forms Module Docs</a>.</p>
...
<table class="table param-table" style="margin:0;">
  ...
  <tbody>
    ...
    <tr>
      <td>ionChange</td>
      <td><p> An expression to evaluate when the checkbox value changes</p>
</td>
    </tr>
