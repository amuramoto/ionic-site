...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic/edit/master//Users/Alex/Desktop/git/ionic/src/components/img/img.ts#L5">
Improve this doc
</a>
...
<p>Two of the biggest cuprits of scroll jank are starting up a new HTTP
...
of images within a scrollable area, then <code>ion-img</code> is better suited
for the job.</p>
...
when it enters the viewport.</p>
<p>The benefits of this approach are that unnecessary and resource intensive
...
an exact size, this further locks in the size of each <code>ion-item</code>,
