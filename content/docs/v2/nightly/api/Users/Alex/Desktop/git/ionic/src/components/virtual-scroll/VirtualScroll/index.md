...
preview_device_url: "/docs/v2/demos/src/virtual-scroll/basic"
...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic/edit/master//Users/Alex/Desktop/git/ionic/src/components/virtual-scroll/virtual-scroll.ts#L10">
Improve this doc
</a>
...
template is referred to as a cell, and can consist of items, headers, and footers.</p>
...
<p>The array of records is passed to the <code>virtualScroll</code> property.
...
<h2 id="section-headers-and-footers">Section Headers and Footers</h2>
...
<h2 id="approximate-widths-and-heights">Approximate Widths and Heights</h2>
...
<h2 id="images-within-virtual-scroll">Images Within Virtual Scroll</h2>
...
<h3 id="ios-cordova-wkwebview">iOS Cordova WKWebView</h3>
...
UIWebView.</p>
<h3 id="lock-in-element-dimensions-and-locations">Lock in element dimensions and locations</h3>
...
via CSS.</p>
<h3 id="use-ion-img-for-images">Use <code>ion-img</code> for images</h3>
...
<h3 id="set-approximate-widths-and-heights">Set Approximate Widths and Heights</h3>
...
created.</p>
<h3 id="changing-dataset-should-use-virtualtrackby-">Changing dataset should use <code>virtualTrackBy</code></h3>
...
<h3 id="efficient-headers-and-footer-functions">Efficient headers and footer functions</h3>
