...
preview_device_url: "/docs/v2/demos/src/note/basic  
<a href='/docs/v2/api/components/api/components/item/item'>ion-item</a>"
...
<a class="improve-v2-docs" href="http://github.com/driftyco/ionic/edit/master//Users/Alex/Desktop/git/ionic/src/components/note/note.ts#L3">
Improve this doc
</a>
...
<p>A note adds a greyed out element that can be on the left or right side of an item.</p>
